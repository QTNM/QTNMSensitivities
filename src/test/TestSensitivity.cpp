...
int main(int argc, char *argv[])
{
  ...
  auto *mg = new TMultiGraph("mg", "arXiv:1309.7093; Effective volume [m^{3}]; 90% CL mass limit [eV]");
  ...
  systs1.push_back(new GasScattering(nGraph1, bGraph, false));
  ...
  systs2.push_back(new GasScattering(nGraph2, bGraph, false));
  ...
  systs3.push_back(new GasScattering(nGraph3, bGraph, false));
  ...
  systs4.push_back(new GasScattering(nGraph4, bGraph, true));
